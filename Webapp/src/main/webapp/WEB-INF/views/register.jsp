...
<head>
  ...
  <link href="<c:url value='/resources/css/agentstyle.css' />" rel="stylesheet">
</head>
    ...
    <div class="card card-register mx-auto mt-5">
	  ...
	  <input class="form-control" type="text"  name="addr1" id="addr1"  placeholder="Enter Address" required/>
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="loginPage.html">Login Page</a>
          <a class="d-block small" href="forgetPwdPage.html">Forgot Password?</a>
        </div>
      </div>
    </div>
  </div>
...
<script>
    ...
    var lastname = $('#lastname').val();
     var email = $('#email').val();
        ...
        var qual = e.options[e.selectedIndex].text;
          ...
          var referralcode = $('#examplereferralcode').val();
   ...
   <!-- <script>
	...
	var str = window.location.href;
	 var word = "referralcode:";
    var afterComma =  str.substr(str.indexOf(word) + word.length);
	document.getElementById("examplereferralcode").value = afterComma;
	console.log(document.getElementById("examplereferralcode").value);
	 });
