...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card-header"><h2 align="center">Issues Registration</h2></div>
      <div class="card-body">
   
  <form id="issueregistration" name="issueregistration">

    <label for="issuename">Issue Name</label>
    <input class="form-control" type="text" name="issuename" id="issuename" placeholder="" required>
	<br>
...
<br>
    ...
    <input class="form-control" type="text" name="isassignedto" id="isassignedto" placeholder="">
	<br>
...
<br>
   ...
   <textarea rows="4" cols="50" id="issuemessage" name="issuemessage" class="form-control" placeholder="Enter Issue Message..." required></textarea>
      <br><label for="issuestatus">Issue Status</label>
     <br>   
...
<input id="searchInput" class="input-controls" type="text" placeholder="Enter a location">
 ...
 return false;   
    ...
    var isassignedfrom = $('#isassignedfrom').val();
     var assignTo = $('#isassignedto').val();
         var email = $('#agentemail').val();
		var	issueMessage = $('#issuemessage').val();
		var	latitude = $('#latitude').val();
		var	longitude = $('#longitude').val();
          var e = document.getElementById("issuestatus");
        var issuestatus = e.options[e.selectedIndex].text;
          
    var json = {"issueName" : issuename,"assignTo" : assignTo,"assignFrom": isassignedfrom,"email" : email,"issueMessage" : issueMessage,"latitude":latitude,"longitude":longitude ,"issueStatus":issuestatus};
          console.log(json);
          
    $.ajax({
        url: "${pageContext.servletContext.contextPath}/admin/issueReportCheck",
        type: 'POST',
        dataType: "json",
        data: {issueReportCommand:JSON.stringify(json)},
    ...
    <script>
    $("#issuename").keyup(function(){
  	  var issueValue = document.getElementById("issuename").value;
  	 console.log(issueValue);
  	  $("#issuename").autocomplete({
  	        minLength: 2,
  	        source: function(request,response) {
  	        	console.log(request);
  	  if(issueValue.length > 2)
  	   {
  	        $.ajax({
  	       type:"POST",
  	       data: {issueValue:issueValue},
		   dataType :"json",
  	       url:"${pageContext.servletContext.contextPath}/allIssuename",
  	       ...
  	       complete: function (result) {
  	        ...
  	        values.push(result.responseJSON[i].issuName);
  	        }
  	        response(values);
  	       },
  	        });
