                        ...
                        <div id="usertable"   style="display:none" >
                            <table id="example" width="100%" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                <thead style="background:#ff6707;color:#fff">
                                    <tr>
									<th class="table_heading">Task Name</th>
                                        <th class="table_heading">Agent Email</th>
                                        <th class="table_heading">Shop Name</th>
                                        <th class="table_heading">Seller Name</th>
                                        <th class="table_heading">Seller Mobile</th>
                                        <th class="table_heading">Total Doc</th>
										...
										<th class="table_heading">Seller Message</th>
										<th class="table_heading">Seller Status</th>
										<th class="table_heading">Seller Deal</th>
										<th class="table_heading">Created Date</th>
										<th class="table_heading">View Messages</th>
                                    </tr>
                                </thead>
                            </table>
                            </div>
...
<form id="taskupdate">
   ...
   <script>
      ...
      $.ajax({
            type: "POST",
            url: "${pageContext.servletContext.contextPath}/admin/GetAllTaskInBackGround",
            data: "startDate=" + document.getElementById('from').value + "&endDate=" + document.getElementById('to').value,
            dataType :"json",
      ...
      $("#usertable").css("display", "block");  
        $.ajax({
            type: "POST",
            url: "${pageContext.servletContext.contextPath}/admin/GetAllTaskInBackGroundByEmail",
            data: "agentEmail="+selectedemail ,
            dataType :"json",
            complete: function (data) {
            	console.log(data.responseJSON);
 ...
 <div id="dialog1" title="Task Message" style="display:none">
<div class="container1"
	style="padding-top: 60px; border: 0px; margin-left: 15px; margin-right: 15px">
		...
		<div class="row">
			<div>
				...
				<table id="taskmessage" class="table table-bordered table-hover">
					<thead style="background:#ff6707;color:#fff">
						<tr>
							<th class="table_heading">Taskmessage Id </th>
							<th class="table_heading"> Task Id</th>
						    <th class="table_heading">Task Message</th>
							<th class="table_heading">Seller Status</th>
							<th class="table_heading">Seller Deal</th>
							<th class="table_heading">Agent Emailid</th>
							<th class="table_heading">Created Date</th>
							<th>Edit</th>
